        ...
        <div class="box-content">
            ...
            if ( is_singular( 'attachment' ) ) {
                ...
                if( get_theme_mod( 'tc_e_commerce_shop_nav_links',true) != '') {
                    ...
                    the_post_navigation( array(
                        'next_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html(get_theme_mod('tc_e_commerce_shop_next_text',__( 'Next Post', 'tc-e-commerce-shop' ))) . '<i class="fas fa-chevron-right"></i></span> ' .
                            '<span class="screen-reader-text">' . __( 'Next Post', 'tc-e-commerce-shop' ) . '</span> ' .
                            '',
                        'prev_text' => '<span class="meta-nav" aria-hidden="true"><i class="fas fa-chevron-left"></i>' . esc_html(get_theme_mod('tc_e_commerce_shop_prev_text',__( 'Previous Post', 'tc-e-commerce-shop' ))) . '</span> ' .
