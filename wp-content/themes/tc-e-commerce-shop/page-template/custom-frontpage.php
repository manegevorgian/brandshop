...
<main id="main" role="main">
  ...
  <?php if( get_theme_mod('tc_e_commerce_shop_slider_hide') != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'tc_e_commerce_shop_slider_speed',3000)) ?>"> 
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <?php if ( get_theme_mod('tc_e_commerce_shop_slider_button_text','LEARN MORE') != '' && get_theme_mod('tc_e_commerce_shop_slider_button',true) != '') {?>
                    <div class="more-btn">              
                      <a href="<?php esc_url(the_permalink()); ?>"><?php echo esc_html( get_theme_mod('tc_e_commerce_shop_slider_button_text',__('LEARN MORE', 'tc-e-commerce-shop')) ); ?><span class="screen-reader-text"><?php esc_html_e( 'LEARN MORE','tc-e-commerce-shop' );?></span></a>
                    </div>
                  <?php }?>
                </div>
              </div>
        ...
        <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
          <span class="carousel-control-prev-icon" aria-hidden="true"><i class="fas fa-chevron-left"></i></span><span class="screen-reader-text"><?php esc_html_e( 'Previous','tc-e-commerce-shop' );?></span>
        </a>
        <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-chevron-right"></i></span><span class="screen-reader-text"><?php esc_html_e( 'Next','tc-e-commerce-shop' );?></span>
        </a>
      </div>  
